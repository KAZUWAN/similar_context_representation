...
def show_attention_heatmap(attention_w_tensor, text, layer_n, save= True, show= False):
...
for i, attention_layer in enumerate(attentions):
    ...
    # show_attention_heatmap(attention_tensor, text, layer_n, save= True, show= False) #batch number 0
    # assert False
